...
function processarDados(dados) {
    ...
    const layout = {
        ...
        height: 700,
        title: {
            text: 'Redes sociais que os jovens da minha escola mais usam',
            x: 0,
            font: {
    ...
    incluirTexto(`Podemos ver então que a rede que os jovens do meu colégio estão mais viciados é o <span>Instagram</span> em relação a outras redes.`)
}
